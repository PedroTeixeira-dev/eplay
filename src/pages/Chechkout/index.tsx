...
const Checkout = () => {
  ...
  const [purchase, { isError, error, data }] = usePurchaseMutation()
  ...
  const getErrorMessage = (fieldName: string, message?: string) => {
    const isToutched = fieldName in form.touched
    const isInvalid = fieldName in form.errors

    if (isToutched && isInvalid) return message
    return ''
  }
            ...
            <>
              ...
              <Row marginTop="24px">
                ...
                <InputGroup maxWidth="123px">
                  <label htmlFor="expiresMonth">Mês do voncimento</label>
                  <input
                    type="text"
                    id="cardMonth"
                    name="expiresMonth"
                ...
                <InputGroup maxWidth="123px">
                  <label htmlFor="expiresYear">Ano do voncimento</label>
                  <input
                    type="text"
                    id="cardYear"
                    name="expiresYear"
